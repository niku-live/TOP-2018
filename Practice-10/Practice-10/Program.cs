...
namespace Practice_10
{
    ...
    { 
        ...
        {
            //Imagine that very big List (with 1 mln. entries) is created
        ...
        static void Main(string[] args)
        {
            ...
            //Using existing web services (https://www.lb.lt/webservices/ExchangeRates/ExchangeRates.asmx)
            ...
            //Create WS client
            var client = new LB.ExchangeRatesSoapClient("ExchangeRatesSoap");
            //Get rate for currency "EUR" for today date            
            Console.WriteLine(client.getExchangeRate("USD", DateTime.Now.ToString("yyyy-MM-dd")));
